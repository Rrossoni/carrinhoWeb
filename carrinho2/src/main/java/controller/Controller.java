...
@WebServlet(urlPatterns = { "/Controller", "/main", "/insert", "/select", "/update", "/delete", "/somar"  })
public class Controller extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		}else if (action.equals("/somar")) {
			calcularProduto(request, response);
		}
	}
	...
	protected void listarProduto(HttpServletRequest request, HttpServletResponse response)
		...
		request.setAttribute("somar", javabeans.getTotal());
	...
	protected void calcularProduto(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException{
		javabeans.setQuantidade(request.getParameter("quantidade"));
		javabeans.setValor(request.getParameter("valor"));
		dao.somarProduto(javabeans);
		//response.sendRedirect("main");
	}
}
